...
import {getFirestore, collection, getDocs, addDoc, doc, addDocs, updateDoc} from 'firebase/firestore/lite'
...
console.log("posts", posts)
  ...
  useEffect(() => {
    async function getTweetList() {
      const myFirestoreIntance = getFirestore(app)
      const myPostCollection = collection(myFirestoreIntance, 'posts')
      console.log("postCollection",myPostCollection)
      
        
        return myFirestoreIntance
          .child('avatar')
          .update("Hello world!")
          .then(() => myFirestoreIntance.once('value'))
