...
// console.log("posts", posts)
  ...
  useEffect(() => {
    async function getTweetList() {
      ...
      // const filteredTweetList = tweetList.forEach(tweet => console.log("tweet",tweet.uid))
      const myArray = Array.from(tweetList.uid)
      // console.log("live tweetList", filteredTweetList)
      console.log("myArray",myArray, "tweetList", tweetList)
    }
    getTweetList() 
  },[picUrl])
