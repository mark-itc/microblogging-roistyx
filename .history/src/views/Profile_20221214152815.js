...
import { getStorage, storage, ref, uploadBytesResumable, getDownloadURL, uploadBytes } from "firebase/storage";
...
export function Profile() {
  ...
  .then(response => {
    ...
    const storageRef = firebase.storage().ref().child(`${profileUpload}`);
