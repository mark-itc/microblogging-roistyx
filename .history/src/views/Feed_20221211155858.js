...
export default function Feed(displayName, username, text, date, avatar, postCollection) {
const [posts, setPosts] = useState(true)
const [loading, setLoading] = useState(true);


const {currentUser, tweetList} = useAuth()
console.log("Feed tweetList",postCollection)
